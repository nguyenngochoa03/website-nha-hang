...
<div class="form-group">
    ...
    <table border="1">
        ...
        foreach ($danhmuc as $key=>$value) {
            ...
            <td>' .$image. '</td>
            <td>' .$description. ' </td>
            <td><a href="?url=suadanhmuc&id='.$id.'"><input   type="button"  value="Sửa"></a></td>
            <td><a href="?url=themdanhmuc"><input   type="submit" name="themmoi" value="Thêm mới"></a></td>           
            <td><a href="?url=xoadanhmuc&id='.$id.'" onclick="return confirm(`Bạn muốn xóa?`)" ; id="delete">
